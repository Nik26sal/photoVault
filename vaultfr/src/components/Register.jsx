...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://your-backend-project-name.vercel.app/user/register', formData);
            await axios.post('https://your-backend-project-name.vercel.app/user/login', {
